...
<div class="projects post-card" style="background-color: rgba(0, 131, 252, 0.22);padding: 1.4em;">
    <h4 style="font-size:1.2em">Aroma</h4>
    ...
    <p style="text-align: right; bottom: 0; right: 0; position: absolute; padding-right: 1.4em; font-style:italic">Eneko Uruñuela</p>
</div>
